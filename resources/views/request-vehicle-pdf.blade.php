...
@section('content')
    ...
    <table id="solicitacao">
        ...
        <tr>
            <td>{{ $solicitacao->id < 10 ? '0' . $solicitacao->id : $solicitacao->id }}</td>
            <td id="status" class="{{ strtolower($solicitacao->statussolicitacao) }}">
                {{ $solicitacao->statussolicitacao }}</td>
